...
function optionsframework_add_admin() {
    ...
    $of_page = add_theme_page( THEMENAME, 'Theme Options', 'manage_options', 'optionsframework', 'optionsframework_options_page');
...
function of_style_only(){
	wp_enqueue_style('iw-admin-style', ADMIN_DIR . 'assets/css/admin-style.css');
...
function of_load_only() 
{
    ...
    wp_enqueue_script('icheck', ADMIN_DIR . 'assets/js/icheck.min.js', 'jquery');
