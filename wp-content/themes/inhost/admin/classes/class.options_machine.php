...
class Options_Machine {
    ...
    static function getSystemRequireStatus() {
        ...
        $file_get_content = @file_get_contents('http://google.com');
        ?>
        <ul class="check-system-status">
            ...
            <li>
                ...
                if(!session_id()){
                    echo '<span class="invalid"><i class="fa fa-times"></i></span>' . __('<span class="label2">Error: Start Session fail. Please setting session save path in php</span>', 'inwavethemes');
                }else {
                    echo '<span class="valid"><i class="fa fa-check"></i></span>';
                }
                ?>
